							...
							<div class="left-side py-2">
								<ul>
									<li>
										...
										<span class="span">Rocket1h</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Nature Made</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
									...
									<li>
										<input type="checkbox" class="checked">
										<span class="span">TruNature</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Kirkland Signature</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Schiff Nutrition International</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Blackmores</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Puritan’s Pride</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Healthy Care</span>
									</li>
								</ul>
							</div>
						</div>
